...
const Build = () => {
    return (
       ...
       <div className='flex flex-col md:flex-row gap-19 my-7 justify-center'>
        <div className='text-white text-center'>
        <p>Total Downloads</p>
        <h2 className='md:text-6xl text-4xl font-semibold my-3'>29.6M</h2>
        <p>21% more than last month</p>
        </div>
                    <div className='text-white text-center'>
                        <p>Total Reviews</p>
                        <h2 className='md:text-6xl text-4xl font-semibold my-3'>906K</h2>
                        <p>46% more than last month</p>
                    </div>
                    <div className='text-white text-center'>
                        <p>Active Apps</p>
                        <h2 className='md:text-6xl text-4xl font-semibold my-3'>132+</h2>
